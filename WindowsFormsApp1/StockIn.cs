            ...
            try
            {
                foreach (var InvHead in Inv_QryHead)
                {
                    ...
                    Console.WriteLine("Sum Weight :" + InvHead.Inv_SumWeight);
                     ...
                     query = "INSERT INTO `StockIn_Header`( `Inv_No`, `Cus_Name`, `Cus_Address`, `Inv_Date`, `User_Name`, `Thai_Price`, `Amt_Price`, `Amt_Items`, `Amt_Count`, `Amt_Weight`) " +
        ...
        public void InsertINVDetail()
        {
            try
            {
                foreach (var InvDetail in Inv_QryDetail)
                {
                    ...
                    string query = "INSERT INTO `StockIn_Detail`( `Inv_No`, `Goods_Code`, `Goods_Description`, `Amt_Piece`, `Goods_Type`, `Goods_Price`, `Amt_Price`) " +
        ...
        public void UpdateGoods()
        {
            ...
            try
            {
                foreach (var InvDetail in Inv_QryDetail)
                {
                   ...
                   query = "UPDATE Goods " +
                           "SET Goods_Description ='"+ InvDetail.Goods_Des + "' ," +
                           "Goods_Total ='" + InvDetail.Goods_SumCount + "' " +
                           "WHERE Goods_CD ='" + InvDetail.Goods_Code + "' ;"; 
